                    ...
                    <div class="card-deck">
                        ...
                        <div class="d-flex justify-content-center centralizado">
                            <div class="card border-primary text-center" style="width: 300px;">
                                ...
                                <div class="card-body">
                                    <a href="/admin/album/adicionar/{{$album->id}}" class="badge badge-info" data-toggle="tooltip" data-placement="right" title="Adicionar Fotos"><i class="material-icons md-18 black">add_a_photo</i></a>
                                    ...
                                    <div class="modal fade" id="exampleModal{{$album->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="card border">
                                                    <div class="card-body">
                                                        <form action="/admin/album/editar/{{$album->id}}" method="post" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="form-group">
                                    ...
                                    <a href="/admin/album/apagar/{{$album->id}}" class="badge badge-danger" data-toggle="tooltip" data-placement="right" title="Excluir"><i class="material-icons md-18">delete</i></a>
                                </div>
                            </div>
                        </div>
                        @endforeach
