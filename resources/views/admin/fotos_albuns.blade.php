            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="card border">
                            <div class="card-body">
                                <form action="/admin/album/foto" method="post" enctype="multipart/form-data">
                                    @csrf
            ...
            <div class="modal fade" id="exampleModalMultiple" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="card border">
                            <div class="card-body">
                                <form action="/admin/album/foto/multiple" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <input type="hidden" name="album" value="{{$album->id}}">
                                        <label for="foto">Foto</label>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">
                                    <form action="/admin/album/foto/editar" method="post">
                                        @csrf
                            ...
                            <div class="modal-body">
                                <a href="/admin/album/foto/apagar/{{$foto->id}}" class="badge badge-danger" data-toggle="tooltip" data-placement="right" title="Excluir"><i class="material-icons md-18">delete</i></a>
...
<br>
<a href="/admin/album" class="btn btn-success"data-toggle="tooltip" data-placement="bottom" title="Voltar"><i class="material-icons white">reply</i></a>
@endsection