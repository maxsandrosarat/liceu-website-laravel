<div class="icons">
    <a href="" class="icon fa-phone-alt" data-toggle="modal" data-target="#exampleModalC"><span class="label">Telefone</span></a>
				<!-- Modal -->
				...
				<div class="modal-dialog" role="document">
					...
					<div class="modal-body" style="text-align: center">
						<h5 class="icon fa-phone"/> (67) 3361-9120 <a href="tel:6733619120" type="button" class="btn btn-sm btn-primary">Ligar</a><br/>
						<h5 class="icon fa-whatsapp"/> (67) 99125-0425 <a href="https://api.whatsapp.com/send?phone=5567991250425&text=Digite%20sua%20mensagem" type="button" class="btn btn-sm btn-success">Mandar Mensagem</a><br/>
						<h5 class="icon fa-envelope"/> colegioliceucg@gmail.com <a href="mailto:sac.pet67@gmail.com" type="button" class="btn btn-sm btn-danger">Mandar um e-mail</a>
					</div>
					</div>
				</div>
				</div>
